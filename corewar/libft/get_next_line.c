...
/*   Updated: 2018/04/12 10:46:41 by tkeynes          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		take_line(char **line, char *buf, const int fd, int rf)
{
...
int		get_next_line(const int fd, char **line, int status)
{
	...
	ret_val = take_line(line, buf, fd, 0);
	return (ret_val);
}
